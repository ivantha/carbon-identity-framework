...
public interface CORSService {
    ...
    void addCORSUrl(String tenantDomain, String url) throws CORSServiceException;

    void addCORSUrls(String tenantDomain, List<String> urls) throws CORSServiceException;

    void deleteCORSUrl(String tenantDomain, String url) throws CORSServiceException;
